...
class Net(nn.Module):
    ...
    def forward(self, data):
        ...
        return  out_dict, perf_loss, lut_loss, ff_loss, bram_loss, dsp_loss, diff_loss, loss_dict, total_loss, 0, diff_embed1, diff_embed2, out_embed
