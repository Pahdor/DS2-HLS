...
# TASK = 'class'                                        
TASK = 'regression'                              ## modify 
parser.add_argument('--task', default=TASK)

SUBTASK = 'train'
# SUBTASK = 'inference'                               ## modify 
...
parser.add_argument('--fix_data_split', type=bool, default=True) 
...
if ('hierarchy' not in graph_type) and ('test' not in graph_type): ## separate_PT original graph
...
################# one-hot encoder ##################
encoder_path = '/home/kzw3933/Desktop/HLS-GNN/dataset/save/encoders.klepto'           ## modify
...
model_path = '/home/kzw3933/Desktop/HLS-GNN/src/logs/dse_results_v18_2025-07-29T16-22-25.343224/run1/test_model_state_dict.pth' ## modify 
model_path_list = []
use_pretrain = False                                                  ## modify 
# if use_pretrain:
#     base_path = 'models'    
#     keyword =  v_db
...
pragma_dim_path = '/home/kzw3933/Desktop/HLS-GNN/dataset/save/pragma_dim.klepto'
parser.add_argument('--pragma_dim_path', default=pragma_dim_path)

boost_base_model_path = '/home/kzw3933/Desktop/HLS-GNN/src/logs/v20-m/mtl_harp/run1/test_model_state_dict.pth'
...
embeddings_path = f'/home/kzw3933/Desktop/HLS-GNN/dataset/embeddings/{v_db}'
...
parser.add_argument('--enhance_graph_embed', default=False)
